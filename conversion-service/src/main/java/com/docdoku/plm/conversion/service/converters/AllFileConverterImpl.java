...
public class AllFileConverterImpl implements CADConverter {
    ...
    private static final String CONF_PROPERTIES = "/com/docdoku/plm/conversion/service/converters/all/conf.properties";
    ...
    public ConversionResultProxy convert(final URI cadFileUri, final URI tmpDirUri)
        ...
        try {
            ...
            if (proc.exitValue() == 0) {
                return new ConversionResultProxy(finalConvertedFile);
            } else {
                throw new ConversionException(
